            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="name" value="{{old('name') ?? $user->name}}" placeholder="User Name" type="text">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Address</label>
                        <input type="text" value="{{old('address') ?? $user->address}}" name="address" placeholder="User address" class="form-control ">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="form-group">
                        <label>City</label>
                        <input type="text" value="{{old('city') ?? $user->city}}" name="city" placeholder="User City" class="form-control">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Phone </label>
                        <input class="form-control" value="{{old('phoneNumber') ?? $user->phoneNumber}}" name="phoneNumber" placeholder="Phone number" type="text">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>House Number </label>
                        <input class="form-control" value="{{old('houseNumber') ?? $user->houseNumber}}" name="houseNumber" placeholder="House number" type="text">
                    </div>
                </div>
            </div>
