            ...
            <div class="row d-flex">
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        ...
                        <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="{{asset('assets/img/login.png')}}"
                                class="image"> </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row px-3">
                                ...
                                <input class="mb-4" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Enter a valid email address">
                            </div>
                            <div class="row px-3"> 
